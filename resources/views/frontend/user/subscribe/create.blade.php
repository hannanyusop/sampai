    ...
    <div class="nk-content-wrap">
        <div class="card card-bordered">
            <div class="card-inner">
                ...
                <x-forms.post :action="route('frontend.user.subscribe.insert')" class="form-validate gy-3">
                <div class="row g-3 align-center">
                        ...
                        <div class="col-lg-7">
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control text-uppercase" id="tracking_no" name="tracking_no" value="{{ old('tracking_no')? old('tracking_no') : "" }}" placeholder="ER123456MY">
                                    @error('tracking_no')
                    ...
                    <div class="row g-3 align-center">
                        ...
                        <div class="col-lg-7">
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="remark" name="remark" value="{{ old('remark')? old('remark') : "" }}" placeholder="Baju Shoppe">
                                    @error('remark')
                        ...
                        <div class="col-lg-7">
                            <div class="form-group">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" name="is_notify" id="is_notify" {{ old('is_notify')? "checked" :"" }}>
