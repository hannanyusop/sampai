            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <p class="p-large">NUJ EXPRESS is a dedicated service designed to facilitate the tracking of parcel arrivals for NUJ customers. The system has been specifically created to enhance the customer experience.</p>
                        @if(!auth()->user())
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ asset('images/logo.png') }}" alt="alternative">
                </div> <!-- end of col -->
            </div> <!-- end of row -->
