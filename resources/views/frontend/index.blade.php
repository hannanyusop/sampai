                    ...
                    <div class="slider-container">
                        <div class="swiper-container image-slider">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <a href="{{ asset('landing/images/9.png') }}" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{ asset('landing/images/9.png') }}" alt="alternative">
                                    </a>
                                </div>

                                <div class="swiper-slide">
                                    <a href="{{ asset('landing/images/10.png') }}" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{ asset('landing/images/10.png') }}" alt="alternative">
                                    </a>
                                </div>

                                <div class="swiper-slide">
                                    <a href="{{ asset('landing/images/11.png') }}" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{ asset('landing/images/11.png') }}" alt="alternative">
                                    </a>
                                </div>

                                <div class="swiper-slide">
                                    <a href="{{ asset('landing/images/12.png') }}" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{ asset('landing/images/12.png') }}" alt="alternative">
                                    </a>
                                </div>

                                <div class="swiper-slide">
                                    <a href="{{ asset('landing/images/13.png') }}" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{ asset('landing/images/13.png') }}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
