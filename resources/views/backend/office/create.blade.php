...
@section('content')
    ...
    <div class="nk-block-head nk-block-head-lg wide-sm">
        <div class="nk-block-head-content">
            ...
            <h2 class="nk-block-title fw-normal">Add Office</h2>
    ...
    <div class="nk-content-wrap">
        <div class="card card-bordered">
            <div class="card-inner">
                <x-forms.post :action="route('admin.office.insert')" class="form-validate gy-3">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <div class="custom-control-wrap">
                                    <input type="text" name="code" id="code" class="form-control text-uppercase" value="{{ old('code') }}" required>
                                    @error('code')
                    ...
                    <div class="row g-3 align-center">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <div class="custom-control-wrap">
                                    <input type="text" name="name" id="name" class="form-control text-uppercase" value="{{ old('name') }}" required>
                                    @error('name')
                                    <span id="fv-type-error" class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="col-lg-7">
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <textarea id="address" name="address" placeholder="Insert your address here . . ." class="form-control" rows="5">{{ old('address') }}</textarea>
                                    @error('address')
