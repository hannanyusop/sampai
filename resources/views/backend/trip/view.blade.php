        ...
        <div class="nk-block">
            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between g-3">
                    ...
                    <div class="nk-block-head-content">
                        <a href="{{ route('admin.trip.index') }}" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-back-alt"></em><span>Back</span></a>
                    </div>
                </div>
            </div>
                            ...
                            @foreach($parcels as $parcel)
                                <div class="nk-tb-item">
                                    ...
                                    <div class="nk-tb-col tb-col-lg">
                                        <span class="tb-date">{{ $parcel->lastTransaction->remark }}</span>
                                    </div>
                                                ...
                                                <div class="drodown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <ul class="link-list-opt no-bdr">
                                                            <li><a href="#"><em class="icon ni ni-check-round"></em><span>View</span></a></li>
                                                            <li><a href="#"><em class="icon ni ni-na"></em><span>X</span></a></li>
