...
<table id="u_body" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #ecf0f1;width:100%" cellpadding="0" cellspacing="0">
    ...
    <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
            ...
            <div id="u_row_1" class="u-row-container v-row-background-image--outer" style="padding: 0px;background-image: url('images/image-2.png');background-repeat: no-repeat;background-position: center top;background-color: transparent">
                <div class="u-row" style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
                    <div class="v-row-background-image--inner" style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                        <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td class="v-row-background-image--outer" style="padding: 0px;background-image: url('images/image-2.png');background-repeat: no-repeat;background-position: center top;background-color: transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr class="v-row-background-image--inner" style="background-color: transparent;"><![endif]-->
                                                ...
                                                <div style="font-size: 14px; line-height: 160%; text-align: center; word-wrap: break-word;">
                                                    ...
                                                    <p style="line-height: 160%; text-align: left;">
                                                        @foreach($pickup->parcels as $parcel)
                                                            {{ $parcel->coding }} ({{ $parcel->tracking_no }}) {{ displayPriceFormat($parcel->total_billing, '$') }} <br/>
                                                        @endforeach
                                                    </p>
                                                    <p style="line-height: 160%; text-align: left;"> </p>
                                                    <p style="line-height: 160%; text-align: left;">Permit {{ displayPriceFormat($pickup->permit, '$') }}</p>
                                                    <p style="line-height: 160%; text-align: left;">Tax {{ displayPriceFormat($pickup->tax, '$') }}</p>
                                                    <p style="line-height: 160%; text-align: left;">Service Charge: {{ displayPriceFormat($pickup->service_charge, '$') }} <br />
                                                        Qty: {{ $pickup->parcels->count() }} <br />
                                                    </p>
                                                    <p style="line-height: 160%; text-align: left;">Amount need to pay total= {{ displayPriceFormat($pickup->total, '$') }} </p>
                                                    <p style="line-height: 160%; text-align: left;"> </p>
                                    ...
                                    <table id="u_content_text_3" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        ...
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 40px;font-family:'Raleway',sans-serif;" align="left">
                                                ...
                                                <div style="font-size: 14px; line-height: 160%; text-align: center; word-wrap: break-word;">
                                                    <p style="font-size: 14px; line-height: 160%;">You have received this email as a registered user of <a href="https://app.nujcourier.my/">https://app.nujcourier.my/</a><a href="https://app.nujcourier.my/"></a></p>
                                                    <p style="font-size: 14px; line-height: 160%;"> </p>
                                                    <p style="font-size: 14px; line-height: 160%;">Norizman Usahasama Courier @ Copyright</p>
                                                </div>
